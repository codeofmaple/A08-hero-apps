        ...
        <div className='p-[4.16%] bg-[#62738210]'>
            <div className='flex md:flex-row flex-col gap-10'>
                ...
                <div className='w-full'>
                    ...
                    <div className='flex md:flex-row flex-col md:items-start items-center  md:justify-normal lg:gap-16 gap-5'>
                        <div className='md:text-start text-center flex flex-col md:items-start  items-center'>
                            <img src={downloadIcon} alt="" className='flex' />
                            <p className=' opacity-80 mt-2'>Downloads</p>
                            <h2 className='font-extrabold lg:text-[2.5rem] md:text-2xl text-[2.5rem]'>{downloads}M</h2>
                        </div>
                        <div className='md:text-start text-center flex flex-col md:items-start  items-center'>
                            <img src={ratingsIcon} alt="" />
                            <p className=' opacity-80 mt-2 text-nowrap'>Average Ratings</p>
                            <h2 className='font-extrabold lg:text-[2.5rem] md:text-2xl text-[2.5rem]'>{ratingAvg} </h2>
                        </div>
                        <div className='md:text-start text-center flex flex-col md:items-start  items-center'>
                            <img src={reviewIcon} alt="" />
                            <p className=' opacity-80 mt-2 text-nowrap'>Total Reviews</p>
                            <h2 className='font-extrabold lg:text-[2.5rem] md:text-2xl text-[2.5rem] '> {reviews}K</h2>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className={`mt-5 w-full md:w-auto ${isInstalled ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                        <a className={`btn flex justify-center items-center ${isInstalled ? 'bg-gray-400' : 'bg-[#00d390]'} text-white px-10 py-5 w-full md:w-auto`}>
            ...
            <div className='space-y-4'>
                <h5 className='font-semibold text-2xl md:text-start text-center'>Description</h5>
